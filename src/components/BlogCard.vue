...
export default {
	...
	methods: {
		editBlog() {
			this.$router.push({ name: 'EditBlogView', params: { blogid: this.post.blogID } });
		},
	...
	<div class="blogCard">
		<div v-show="editPost" class="icons">
			<div class="icon" @click="editBlog">
				<InlineSvg :src="editIcon" class="edit" />
			</div>
			<div class="icon" @click="deletePost">
				<InlineSvg :src="deleteIcon" class="delete" />
			</div>
		</div>
		...
		<div class="info">
			...
			<router-link
				class="link"
				:to="{ name: 'BlogView', params: { blogid: this.post.blogID } }">
				Ver la publicación <InlineSvg :src="arrowIcon" class="arrow" />
			</router-link>
		</div>
	</div>
</template>
